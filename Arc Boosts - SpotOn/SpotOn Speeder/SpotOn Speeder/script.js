...
var Vue = (function (e) {
  ...
  function Kc(e, t, { helper: n, push: o, newline: r, isTS: s }) {
    ...
    for (let l = 0; l < e.length; l++) {
      ...
      c && (n = n.slice(0, -6)),
        o(
          `const ${nc(n, t)} = ${i}(${JSON.stringify(n)}${c ? ", true" : ""})${s ? "!" : ""
          }`
        ),
        l < e.length - 1 && r();
    }
...
(() => {
  ...
  document.createElement = function (s) {
    ...
    return ("video" != s && "audio" != s) || (t = i), i;
  };
  const s = () => {
    (() => {
      const e = localStorage.getItem("pb-settings-speed"),
        t = localStorage.getItem("pb-settings-prepitch");
      e &&
        (localStorage.setItem("sps-speed", Number(e) / 100),
          localStorage.removeItem("pb-settings-speed")),
        t &&
        (localStorage.setItem("sps-pp", t),
          localStorage.removeItem("pb-settings-prepitch"));
    })();
    try {
      console.log("sps > adding to page"),
        (() => {
        ...
        (() => {
          ...
          e.id = "sps";
          const t = document.querySelector(".volume-bar").parentNode;
          t.insertBefore(e, t.firstChild);
        })(),
        (() => {
          const { ref: e, watch: s, onMounted: i, computed: r } = Vue,
            l = Vue.createApp({
              template:
                '<div v-if="showMain" id="sps-main"><Settings v-if="showSettings":speed-min="speedMin":speed-max="speedMax"@close="showSettings = false"@save="saveSettings"/><Controls v-else :speed="speed":speed-min="speedMin":speed-max="speedMax":preserve-pitch="preservePitch"@speed-change="speed = $event"@toggle-pp="preservePitch = !preservePitch"@show-settings="showSettings = true"/></div><BottomBarIcon @click="showMain = !showMain":active="showMain":speed="speed"/>',
              name: "Sps",
              setup: () => {
                const r = e(1),
                  l = e(0.5),
                  ...
                  n = e(!0);
                i(() => {
                  const e = localStorage.getItem("sps-speed"),
                    s = localStorage.getItem("sps-pp"),
                    i = localStorage.getItem("sps-speed-min"),
                    o = localStorage.getItem("sps-speed-max");
                  e && (r.value = Number(e)),
                    s && (n.value = "true" === s),
                    i && (l.value = Number(i)),
                    o && (a.value = Number(o)),
                    setInterval(() => {
                      (t.playbackRate = r.value), (t.preservesPitch = n.value);
                    }, 200);
                });
                const o = e(!1),
                  p = e(!1);
                return (
                  s(r, () => {
                    localStorage.setItem("sps-speed", r.value);
                  }),
                  s(n, () => {
                    localStorage.setItem("sps-pp", n.value);
                  }),
                  s(p, () => {
                    o.value = !1;
                  }),
                  {
                    ...
                    saveSettings: (e) => {
                      (l.value = e.min),
                        (a.value = e.max),
                        localStorage.setItem("sps-speed-min", e.min),
                        localStorage.setItem("sps-speed-max", e.max),
                        (o.value = !1);
                    },
                  }
                );
          ...
          l.component("BottomBarIcon", {
            template:
              '<div id="sps-bottombaricon" :class="{\'sps-icon-active\': mainActive, \'sps-hover-white\': !mainActive }"><svg preserveAspectRatio="xMidYMid meet"width="2rem" height="2rem"viewBox="0 0 24 24"fill="currentColor"style="padding: 0.375rem;"><path d="M11.628 16.186l-2.047-2.14 6.791-5.953 1.21 1.302zm8.837 6.047c2.14-2.14 3.535-5.117 3.535-8.466 0-6.604-5.395-12-12-12s-12 5.396-12 12c0 3.35 1.302 6.326 3.535 8.466l1.674-1.675c-1.767-1.767-2.79-4.093-2.79-6.79A9.568 9.568 0 0 1 12 4.185a9.568 9.568 0 0 1 9.581 9.581c0 2.605-1.116 5.024-2.79 6.791Z" fill="currentColor"></path></svg><span style="margin-top: -0.125rem;font-size: .6875rem;"> {{ prettyValue }} </span></div>',
            name: "BottomBarIcon",
            props: { active: Boolean, speed: Number },
            setup: (e) => ({
              mainActive: r(() => e.active),
              prettyValue: r(() => {
                const t = parseFloat(e.speed);
                return t % 1 == 0
                  ? `${t}.00x`
                  : `${t.toString().padEnd(4, "0")}x`;
              }),
            }),
          }),
            l.component("Controls", {
              template:
                '<div id="sps-controls"><div style="display: flex; flex-wrap: nowrap; align-items: center; height: 32px"><img src="https://github.com/SenpaiHunters/SpotOn/blob/Main/Arc%20Boosts%20-%20SpotOn/SpotOn%20Speeder/Logo/SpotOn-Speeder-Logo.png?raw=true" alt="logo-image" style="width:40%"></img><div style="flex-grow: 1;"></div><button class="sps-text-button"style="color: white; font-weight: 600; font-size: 0.625rem; padding: 0.125rem 0.25rem; border-radius: 0.125rem"@click="$emit(\'showSettings\')"> <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 14 16" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M14 8.77v-1.6l-1.94-.64-.45-1.09.88-1.84-1.13-1.13-1.81.91-1.09-.45-.69-1.92h-1.6l-.63 1.94-1.11.45-1.84-.88-1.13 1.13.91 1.81-.45 1.09L0 7.23v1.59l1.94.64.45 1.09-.88 1.84 1.13 1.13 1.81-.91 1.09.45.69 1.92h1.59l.63-1.94 1.11-.45 1.84.88 1.13-1.13-.92-1.81.47-1.09L14 8.75v.02zM7 11c-1.66 0-3-1.34-3-3s1.34-3 3-3 3 1.34 3 3-1.34 3-3 3z"></path></svg> </button></div><div style="display: flex; flex-wrap: nowrap; align-items: center; height: 32px"><span style="line-height: 32px;">{{ props.speedMin }}x</span><input id="sps-input-slider"type="range":min="props.speedMin":max="props.speedMax"step="0.01"v-model="sliderValue"style="margin: 0 0.75rem"/><span style="line-height: 32px;">{{ props.speedMax }}x</span></div><div style="display: flex; flex-wrap: nowrap; align-items: center; height: 32px"><div @click="$emit(\'togglePp\')":class="{\'sps-icon-active\': props.preservePitch, \'sps-hover-white\': !props.preservePitch }"style="display: flex; flex-wrap: nowrap; align-items: center; user-select: none"><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="2rem" height="3rem" preserveAspectRatio="xMidYMid meet" viewBox="0 0 576 512"><path v-if="!props.preservePitch" fill="currentColor" d="M384 64H192C85.961 64 0 149.961 0 256s85.961 192 192 192h192c106.039 0 192-85.961 192-192S490.039 64 384 64zM64 256c0-70.741 57.249-128 128-128c70.741 0 128 57.249 128 128c0 70.741-57.249 128-128 128c-70.741 0-128-57.249-128-128zm320 128h-48.905c65.217-72.858 65.236-183.12 0-256H384c70.741 0 128 57.249 128 128c0 70.74-57.249 128-128 128z"/><path v-else fill="currentColor" d="M384 64H192C86 64 0 150 0 256s86 192 192 192h192c106 0 192-86 192-192S490 64 384 64zm0 320c-70.8 0-128-57.3-128-128c0-70.8 57.3-128 128-128c70.8 0 128 57.3 128 128c0 70.8-57.3 128-128 128z"/></svg><span style="margin-left: 0.5rem; line-height: 1"> Preserve Pitch </span></div><div style="flex-grow: 1;"></div><button @click="sliderValue = 1"class="sps-text-button"style="color: white; font-weight: 600; font-size: 0.625rem; padding: 0.125rem 0.25rem; border-radius: 0.125rem"> <svg stroke="currentColor" fill="none" stroke-width="0" viewBox="0 0 15 15" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M4.85355 2.14645C5.04882 2.34171 5.04882 2.65829 4.85355 2.85355L3.70711 4H9C11.4853 4 13.5 6.01472 13.5 8.5C13.5 10.9853 11.4853 13 9 13H5C4.72386 13 4.5 12.7761 4.5 12.5C4.5 12.2239 4.72386 12 5 12H9C10.933 12 12.5 10.433 12.5 8.5C12.5 6.567 10.933 5 9 5H3.70711L4.85355 6.14645C5.04882 6.34171 5.04882 6.65829 4.85355 6.85355C4.65829 7.04882 4.34171 7.04882 4.14645 6.85355L2.14645 4.85355C1.95118 4.65829 1.95118 4.34171 2.14645 4.14645L4.14645 2.14645C4.34171 1.95118 4.65829 1.95118 4.85355 2.14645Z" fill="currentColor"></path></svg> </button></div></div>',
              name: "Controls",
              props: {
                speed: Number,
                speedMin: Number,
              ...
              emits: ["showSettings", "speedChange", "speedReset", "togglePp"],
              setup: (t, { emit: r }) => {
                const l = e(1);
                return (
                  s(l, (e, t) => {
                    const s = document.querySelector("#sps-input-slider"),
                      i = s.min,
                      l = s.max,
                      a = e;
                    (s.style.backgroundSize =
                      (100 * (a - i)) / (l - i) + "% 100%"),
                      r("speedChange", Number(e));
                  }),
                  i(() => {
                    (() => {
                      const e = document.querySelector("#sps-input-slider");
                      l.value = t.speed;
                      const s = e.min,
                        i = e.max,
                        r = e.value;
                  ...
                  { props: t, sliderValue: l }
                );
              },
            }),
            l.component("Settings", {
              template:
                '<div id="sps-settings"><div style="display: flex; flex-wrap: nowrap; align-items: center; height: 32px"><span style="color: rgb(240, 240, 240); font-weight: 600; line-height: 1;"> Settings </span><div style="flex-grow: 1;"></div><button class="sps-text-button"style="color: white; font-weight: 600; font-size: 0.625rem; padding: 0.125rem 0.25rem; border-radius: 0.125rem"@click="$emit(\'close\')"> <svg stroke="currentColor" fill="none" stroke-width="0" viewBox="0 0 15 15" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z" fill="currentColor"></path></svg> </button></div><div style="display: flex; flex-wrap: wrap; width: 152px"><label style="width: 100%; display: flex; flex-wrap: nowrap; align-items: center; height: 32px;"> Min-Speed: <div style="flex-grow: 1;"></div><input type="number"min="0.01"max="15.999"step="0.1"v-model.number="min"style="margin-left: 0.5rem; width: 56px; border-radius: 0.125rem; padding-left: 0.125rem; padding-right: 0.125rem; text-align: center; font-size: 0.875rem; background-color:rgb(83, 83, 83);"></label><label style="width: 100%; display: flex; flex-wrap: nowrap; align-items: center; height: 32px;"> Max-Speed: <div style="flex-grow: 1;"></div><input type="number"min="1"max="16"step="0.1"v-model.number="max"style="margin-left: 0.5rem; width: 56px; border-radius: 0.125rem; padding-left: 0.125rem; padding-right: 0.125rem; text-align: center; font-size: 0.875rem; background-color:rgb(83, 83, 83);"></label></div><div style="display: flex; flex-wrap: nowrap; align-items: center; height: 32px; justify-content: center;"><button @click="reset"class="sps-text-button" style="color: white; font-weight: 600; font-size: 0.625rem; padding: 0.125rem 0.25rem; border-radius: 0.125rem; width: 50%;"> RESET </button><button @click="$emit(\'save\', { min, max })":disabled="min === \'\' || max === \'\'"class="sps-text-button"style="margin-left: 0.5rem; color: white; font-weight: 600; font-size: 0.625rem; padding: 0.125rem 0.25rem; border-radius: 0.125rem; width: 50%;"> SAVE </button></div></div>',
              name: "Settings",
              props: { speedMin: Number, speedMax: Number },
              emits: ["close", "save"],
              setup: (t, { emit: r }) => {
                const l = e(0.5),
                  a = e(2),
                ...
                return (
                  i(() => {
                    (l.value = t.speedMin), (a.value = t.speedMax);
                  }),
                  s(l, (e, t) => {
                    e >= a.value && (l.value = a.value - 0.01),
                      (l.value = Number(l.value.toFixed(2)));
                  }),
                  s(a, (e, t) => {
                    e < l.value && (a.value = l.value + 0.01),
